...
class AuthorCreateViewTest(TestCase):
    def setUp(self):
        ...
        # Create an author 
        test_author = Author.objects.create(first_name='John', last_name='Smith')
        test_author2 = Author.objects.create(first_name='Taras', last_name='Shevchenko')
        test_author3 = Author.objects.create(first_name='Edgar Allan', last_name='Poe')
        ...
        def test_redirects_to_detail_view_on_success(self):
            ...
            # Manually check redirect because we dont know if author was created
            self.assertEqual(response.status_code, 302)
